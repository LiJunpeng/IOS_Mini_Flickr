...
class FlickrHelper: NSObject {
    ...
    func searchFlickrForString(searchStr:String, completion:(searchString:String!, flickrPhotos:NSMutableArray!, error:NSError!)->()){
        ...
        dispatch_async(queue, {
            ...
            do{
                let searchResultString:String! = try NSString(contentsOfURL: NSURL(string: searchURL)!, encoding: NSUTF8StringEncoding) as String
            ...
            //===========================================
                ...
                //===========================================
                    ...
                    do{
                        let resultDict:NSDictionary! = try NSJSONSerialization.JSONObjectWithData(jsonData, options: NSJSONReadingOptions(rawValue: 0)) as!     NSDictionary
                    }
                    catch
                    {
                        print("wrong 2")
